...
document.addEventListener('DOMContentLoaded', () => {
    ...
    enviarCodigoBtn.addEventListener("click", () => {
        ...
        const mensagem = `Seu código de verificação: *${codigoGerado}*. Use este código para confirmar seu número.`;
    ...
    confirmarCodigoBtn.addEventListener("click", () => {
        ...
        const mensagemSeguranca = "Agora ative a proteção em duas etapas no WhatsApp para maior segurança. Acesse: Configurações > Conta > Confirmação em duas etapas.";
